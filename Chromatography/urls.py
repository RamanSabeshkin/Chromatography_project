...
urlpatterns = [
    ...
    path('delete_logp_model/<int:id>/', views.delete_logpmodel, name='delete_logpmodel'),
    path('delete_lser_model/<int:id>/', views.delete_lsermodel, name='delete_lsermodel'),
    path('delete_column/<int:id>/', views.delete_column, name='delete_column'),
